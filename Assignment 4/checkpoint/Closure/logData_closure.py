...
commands.append([0, 0, T_WAT])           # WAIT
commands.append([P_FWD, P_FWD, 4.2])     # FWD
commands.append([0, 0, T_WAT])           # WAIT
...
# Run
commands = []
commands.append([P_FWD, P_FWD, 2.2])     # FWD
commands.append([0, 0, T_WAT])           # WAIT
commands.append([P_TRN, -P_TRN, T_TRN - .1])  # TURN RIGHT
commands.append([0, 0, T_WAT])           # WAIT
commands.append([P_FWD, P_FWD, 7.3])     # FWD
commands.append([0, 0, T_WAT])           # WAIT
runCommands(log, commands)
